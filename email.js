...
//  M4 (Fase 3): escape de HTML para prevenir XSS en correos.
...
<p style="margin: 0;"><strong> Importante:</strong> Por seguridad, el sistema te pedirá cambiar esta contraseña la primera vez que ingreses.</p>
</div>
<div style="text-align: center; margin: 30px 0;">
...
<div style="background: #fef3c7; padding: 15px; border-left: 4px solid #f59e0b; margin: 15px 0; border-radius: 4px;">
<p style="margin: 0;"><strong> Importante:</strong> Este enlace expira en 7 días y solo puede usarse una vez. Si no lo activas, contacta al administrador.</p>
</div>
<p style="color: #6b7280; font-size: 14px; margin-top: 30px; border-top: 1px solid #e5e7eb; padding-top: 20px;">
Si no reconoces esta cuenta o tienes problemas para acceder, contacta al administrador.
</p>
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
<div style="background: #8600dd; color: white; padding: 20px; text-align: center; border-radius: 8px 8px 0 0; border-bottom: 4px solid #e9a427;">
<h2 style="margin: 0;"> Recordatorio de Documentos Pendientes</h2>
</div>
<div style="background: white; padding: 25px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
...
<strong> Importante:</strong> Ingresa a tu panel para subir los documentos faltantes;
...
<div style="background: #fef3c7; padding: 15px; border-left: 4px solid #f59e0b; margin: 20px 0; border-radius: 4px;">
<p style="margin: 0; color: #92400e; font-size: 14px;">
<strong> Importante:</strong> Tu documentación anterior será archivada y deberás subir nueva documentación para continuar como proveedor activo.
</p>
</div>
<div style="text-align: center; margin: 30px 0;">
